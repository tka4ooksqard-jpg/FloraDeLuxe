...
export const galleryItems: readonly GalleryItem[] = [
  {
    ...
    title: "Оптовий зал",
    caption: "Загальний вигляд асортименту на оптовому складі Kyiv OPT.",
    image: {
      src: "/images/gallery/wholesale-hall-premium.webp",
      alt: "Загальний вигляд оптового залу з рядами квітів",
      width: 1600,
      height: 2000,
      isPlaceholder: false,
    },
  ...
  // —— Video tiles. Poster frames from the same visual series. ——
  {
    ...
    orientation: "landscape",
    title: "Оптовий зал",
    caption: "Коротке відео асортименту на складі.",
    videoSrc: "/videos/warehouse/wholesale-floor.mp4",
    image: {
      src: "/images/gallery/wholesale-hall-premium.webp",
      alt: "Відео: загальний вигляд оптового залу",
      width: 1600,
      height: 2000,
      isPlaceholder: false,
    },
